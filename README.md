...
* Due to many requests received, I'm planing to upgrade this project to latest CUDA and CUDDP versions. However, I'm currently too busy with work, and there is no specific timeline about this upgrade. GPU platform donation/sharing with be appreciated.*
